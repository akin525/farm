                                    ...
                                    <div class="card bg-primary text-white">
                                        <div class="card-header border-0 flex-wrap">
                                            <div class="revenue-date">
                                                ...
                                                <h4 class="text-white">₦{{$todaypurchase}}</h4>
                                            </div>
                                ...
                                <div class="col-xl-6 col-sm-6">
                                    <div class="card bg-secondary text-white">
                                        <div class="card-header border-0">
                                            <div class="revenue-date">
                                                <span class="text-black">Today Payment</span>
                                                <h4 class="text-black">₦{{$todaypayment}}</h4>
                                            </div>
                                            <div class="avatar-list avatar-list-stacked me-2">
                                        ...
                                        <div class="card-body depostit-card">
                                            ...
                                            <div class="progress-box mt-0">
                                                <div class="d-flex justify-content-between">
                                                    <p class="mb-0">Numbers of Purchase</p>
{{--                                                    <p class="mb-0">20/28</p>--}}
                                                </div>
                                                <div class="progress">
                                                    <div class="progress-bar bg-secondary" style="width:{{$todaypurchasenumber}}%; height:5px; border-radius:4px;" role="progressbar"></div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-xl-6 col-sm-6">
                                    <div class="card same-card">
                                        <div class="card-body depostit-card p-0">
                                            ...
                                            <div class="progress-box mt-0">
                                                <div class="d-flex justify-content-between">
                                                    <p class="mb-0">Numbers of Payment</p>
                                                    {{--                                                    <p class="mb-0">20/28</p>--}}
                                                </div>
                                                <div class="progress">
                                                    <div class="progress-bar bg-secondary" style="width:{{$todaypaymentnumber}}%; height:5px; border-radius:4px;" role="progressbar"></div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-xl-6 col-sm-6">
                                    <div class="card bg-primary text-white">
                                        <div class="card-header border-0 flex-wrap">
                                            <div class="revenue-date">
                                                <span>New Users</span>
                                                <h4 class="text-white">{{$newuser}}</h4>
                                            </div>
                                            <div class="avatar-list avatar-list-stacked me-2">
                                                <img src="images/contacts/pic555.jpg" class="avatar rounded-circle" alt="">
                                                <img src="images/contacts/pic666.jpg" class="avatar rounded-circle" alt="">
                                ...
                                <div class="col-xl-6 col-sm-6">
                                    <div class="card bg-secondary text-white">
                                        <div class="card-header border-0">
                                            <div class="revenue-date">
                                                <span class="text-black">Today Sales</span>
                                                <h4 class="text-black">₦{{$todaypayment}}</h4>
                                            </div>
                                            <div class="avatar-list avatar-list-stacked me-2">
															<span class="avatar rounded-circle bg-white">
...
{{--                                    </ul>--}}
                        ...
                        <div class="col-xl-4">
                            <div class="card">
                                <div class="card-header border-0 flex-wrap">
                                    <h4 class="heading mb-0">Activities</h4>
{{--                                    <div>--}}
                                                        ...
                                                        <div class="d-items-2">
                                                            ...
                                                            <div>
                                                                <div class="form-check custom-checkbox">
                                                                    ...
                                                                    <label class="form-check-label" for="customCheckBox1">{{$act['description']}}</label>
                                                                </div>
